...
namespace SetOperators
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // samples.Linq46(); Console.Read(); // This sample uses Distinct to remove  duplicate  elements in a sequence of factors of 300

            samples.Linq47(); Console.Read();// This sample uses Distinct to find the unique Category names
        ...
        class LinqSamples
        {
            ...
            public void Linq47()
            {
                ...
                IEnumerable<Product> categoryNames =
                   (from prod in products
                    select prod.Category);
                    .Distinct();

                Console.WriteLine("Category names:");
                foreach (Product n in categoryNames)
                {
                    Console.WriteLine(n);
                }
            }
